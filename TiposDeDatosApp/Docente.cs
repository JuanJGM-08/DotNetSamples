...
namespace TiposDeDatosApp
{
    ...
    public class Docente : Persona
    {
       ...
       public Docente(int idest, string nom, string apel, string dir, string ema, int tel, DateTime fen, DateTime fin)
        {
            this.Id = idest;
            this.Nombres = nom;
            this.Apellidos = apel;
